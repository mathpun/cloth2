...
var super_task = function (spec,my) {
    ...
    (function () {
			...
			if (invalid) {
				...
				msg = msg + "from researchers at MIT's Department of Brain and Cognitive Science.<br><br>";
				// msg = msg + 'Please email Brenden Lake at <a href="mailto:brenden@mit.edu">brenden@mit.edu</a> with any questions.';
				my.throw_error(msg);
			}
			...
			if (tu.flagChrome()) {
				...
				// msg = msg + 'Email Brenden Lake at <a href="mailto:brenden@mit.edu">brenden@mit.edu</a> with any questions.';
				my.throw_error(msg);	
			}
